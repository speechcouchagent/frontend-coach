...
import { useUserContext } from "@/app/context/UserContext"; // adjust path

export default function LoginPage() {
  const { setEmail } = useUserContext(); // get setEmail from context
  ...
  const handleLogin = async () => {
    ...
    try {
      ...
      if (res.ok && data.token) {
        ...
        // Update context (and localStorage) with the user's email
        setEmail(localEmail);
      ...
      <section className="bg-white py-8 px-4 text-center">
        <div className="max-w-md mx-auto">
          ...
          <p className="text-gray-600">
            Log in to access your account and continue your AI coaching.
          </p>
        </div>
      </section>
